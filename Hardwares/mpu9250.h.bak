...
MPU9250* MPU9250_Create(SPI_HandleTypeDef *hspi, GPIO_TypeDef *cs_port, uint16_t cs_pin);
void MPU9250_Destroy(MPU9250 *mpu);
...
uint8_t MPU9250_VerifyConnection(MPU9250 *mpu);
uint8_t MPU9250_ResetDevice(MPU9250 *mpu);
