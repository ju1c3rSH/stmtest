...
const PID_Type_Map_t pid_type_map[] = {
...
// NOTE: I_Max �?Out_Max 不在此处初始化，而是�?Car_Init() 中硬编码�?
...
PID_TypeDef g_stored_pid_params[PID_TYPE_COUNT] = {
    ...
    // filter_alpha: 误差低通滤波系数，0=无滤波，1=全滤�?
    // 编码器速度滤波建议�? 0.3~0.7 (当前0.9偏大，相位滞后会明显)
    // 对于连续PID系统，建议从0.5开始调试，根据响应速度和噪声权�?
