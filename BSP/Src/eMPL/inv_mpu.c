...
static signed char gyro_orientation[9] = { 1, 0, 0,
                                           0, 1, 0,
                                           0, 0, 1};
static long s_gyro_bias_q16[3] = {0, 0, 0};

void mpu_get_gyro_bias(float *bias)
{
    bias[0] = (float)s_gyro_bias_q16[0] / 65536.0f;
    bias[1] = (float)s_gyro_bias_q16[1] / 65536.0f;
    bias[2] = (float)s_gyro_bias_q16[2] / 65536.0f;
}
...
uint8_t run_self_test(void)
{
	...
	if (result == 0x7) 
	{
		...
		*/
        ...
        s_gyro_bias_q16[0] = gyro[0];
        s_gyro_bias_q16[1] = gyro[1];
        s_gyro_bias_q16[2] = gyro[2];
		return 0;
	}else return 1;
}
//�����Ƿ������?
...
uint8_t mpu_dmp_init(void)
{
	...
	mpu_init();
		...
		if(res)return 6; 
		res=dmp_set_fifo_rate(DEFAULT_MPU_HZ);	//����DMP�������?��󲻳���?00Hz)
		if(res)return 7;   
		res=run_self_test();		//�Լ�
		if(res)return 8;    
