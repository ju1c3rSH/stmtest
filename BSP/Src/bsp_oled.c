...
void OLED_W_SCL(uint8_t BitValue)
{
	...
	HAL_GPIO_WritePin(m_oled_props.scl_gpio_port, m_oled_props.scl_gpio_pin, (GPIO_PinState)BitValue);
...
void OLED_W_SDA(uint8_t BitValue)
{
	...
	HAL_GPIO_WritePin(m_oled_props.sda_gpio_port, m_oled_props.sda_gpio_pin, (GPIO_PinState)BitValue);
	//	Delay_us(1);
	// DWT_Delay_us(2);
